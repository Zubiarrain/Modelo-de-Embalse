...
Item{
    ...
    property var list1:["Nivel Mínimo [m]:","Potencia Firme [MW]:","Rendimiento:"]
    property var list2:["Nivel Mínimo [m]:","Déficit Buscado [%]:","Rendimiento:"]
    property var list3:["Nivel Mínimo Límite [m]:","Déficit Buscado [%]:","Paso de Cálculo:","Rendimiento:"]
    property var lista:[list1,list2,["Déficit Buscado [%]:","Rendimiento:"]]
    ...
    Connections {
        ...
        // CUSTOM PROPERTIES
        property var resultadosTotalENNV
        property var resultadosFallaENNV
        property var resultadosGarantiaENNV

        function onSignalResultadosTotalENNV(myResultadosTotalENNV){resultadosTotalENNV = myResultadosTotalENNV}
        function onSignalResultadosFallaENNV(myResultadosFallaENNV){resultadosFallaENNV = myResultadosFallaENNV}
        function onSignalResultadosGarantiaENNV(myResultadosGarantiaENNV){resultadosGarantiaENNV = myResultadosGarantiaENNV}

        function onSignalFinishENNV(myString){
            var btn
            var btn_resultados
            var btn_exportar
            var btn_curva
        ...
        function verification(indice,btn){
            ...
            if(info_completa){
                ...
                if(indice == 0){backend.calculo_total_ennv(data)}
                else if(indice == 1){backend.calculo_falla_ennv(data)}
                else if(indice == 2){backend.calculo_garantia_ennv(data)}
            }
            
        }

        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorTotalENNV(myError){
        ...
        function showResults_total(){
            console.log(resultadosTotalENNV)
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosTotalENNV
            win.show()
            visible = true
        }

        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorFallaENNV(myError){
        ...
        function showResults_falla(){
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosFallaENNV
            win.show()
            visible = true
        }
        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorGarantiaENNV(myError){
        ...
        function showResults_garantia(){
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosGarantiaENNV
            win.show()
            visible = true
        }
    }
