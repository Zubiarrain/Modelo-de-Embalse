...
Item{
    ...
    property var list1:["Nivel Mínimo [m]:","Nivel Máximo [m]:","Potencia Firme [MW]:","Rendimiento:"]
    property var list2:["Nivel Mínimo [m]:","Nivel Máximo [m]:","Déficit Buscado [%]:","Rendimiento:"]
    property var list3:["Nivel Máximo [m]:","Nivel Mínimo Límite [m]:","Déficit Buscado [%]:","Paso de Cálculo:","Rendimiento:"]
    property var lista:[list1,list2,["Nivel Máximo [m]:","Déficit Buscado [%]:","Rendimiento:"]]
        ...
        ScrollView{
            ...
            Rectangle {
                ...
                GridLayout {
                    ...
                    Repeater{
                        model:["CONSIGNA POTENCIA","CONSIGNA DÉFICIT","CURVA POT-NmN"]
                        Rectangle{
                    ...
                    Button{
                        ...
                        flat:true
                        hoverEnabled:false
                        onClicked: backend.export_excel_total_en()
                    ...
                    Button{
                        ...
                        opacity:5
                        onClicked: backend.export_excel_falla_en()
                        contentItem: Item{
                            Text {
                    ...
                    Button{
                        ...
                        flat:true
                        hoverEnabled:false
                        onClicked: backend.export_excel_garantia_en()
                        contentItem: Item{
                            Text {
                    ...
                    Button{
                        ...
                        flat:true
                        hoverEnabled:false
                        onClicked: backend.curva_duracion_total_en()
                    ...
                    Button{
                        ...
                        opacity:5
                        onClicked: backend.curva_duracion_falla_en()
                        contentItem: Item{
                            Text {
                    ...
                    Button{
                        ...
                        flat:true
                        hoverEnabled:false
                        onClicked: backend.curva_garantia_en()
                        contentItem: Item{
                            Text {
    ...
    Connections {
        ...
        // CUSTOM PROPERTIES
        property var resultadosTotalEN
        property var resultadosFallaEN
        property var resultadosGarantiaEN

        function onSignalResultadosTotalEN(myResultadosTotalEN){resultadosTotalEN = myResultadosTotalEN}
        function onSignalResultadosFallaEN(myResultadosFallaEN){resultadosFallaEN = myResultadosFallaEN}
        function onSignalResultadosGarantiaEN(myResultadosGarantiaEN){resultadosGarantiaEN = myResultadosGarantiaEN}

        function onSignalFinishEN(myString){
            var btn
            var btn_resultados
            var btn_exportar
            var btn_curva
        ...
        function verification(indice,btn){
            ...
            if(info_completa){
                ...
                if(indice == 0){backend.calculo_total_en(data)}
                else if(indice == 1){backend.calculo_falla_en(data)}
                else if(indice == 2){backend.calculo_garantia_en(data)}
            }
            
        }

        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorTotalEN(myError){
        ...
        function showResults_total(){
            console.log(resultadosTotalEN)
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosTotalEN
            win.show()
            visible = true
        }

        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorFallaEN(myError){
        ...
        function showResults_falla(){
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosFallaEN
            win.show()
            visible = true
        }
        // FUNCTION TO MANAGE ERRORS
        function onSignalErrorGarantiaEN(myError){
        ...
        function showResults_garantia(){
            var component = Qt.createComponent("app.qml")
            var win = component.createObject()
            win.resultados = resultadosGarantiaEN
            win.show()
            visible = true
        }
    }
