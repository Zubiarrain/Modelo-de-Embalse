...
class CalculoFalla:
    ...
    def __init__(self,input_data,falla_buscada, nivel_min, rendimiento, potencia_firme=0) -> None:

        c_handler = log.FileHandler('ENERGÍA_NMV-Consigna_Déficit.log',encoding='utf-8')
    ...
    def _ajuste_falla(self):
        ...
        logger.info(f'Iteración: {self.iteraciones} || Potencia Firme: {self.potencia_firme} || Déficit Obtenido: {self.falla_obtenida_exacta} / {self.falla_buscada}')
    ...
    def _calcular_falla(self):
        ...
        while True:
            ...
            try:
                ...
                if self.falla_obtenida != round(self.falla_buscada,2):
