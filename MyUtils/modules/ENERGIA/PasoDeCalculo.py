...
class PasoDeCalculo:
    ...
    def __init__(self,time,nivel_inicial,volumen_inicial,area_inicial,caudal_entrante,evaporacion,precipitacion,nivel_volumen,nivel_min,nivel_max,potencia_firme,nivel_restitucion,caudal_nivelRes, rendimiento):
        ...
        # ----------- ITERACION CAUDAL - NRES - H -----------------
        # Se realiza la iteración Q-Nres-H para hasta que el nivel de restitucion calculado al cuarto decimal sea igual al del paso anterior.
        self.caudal_objetivo = interpolation(self.caudal_nivelRes[0],self.caudal_nivelRes[1],self.nivel_restitucion,'y',"Nres")
        self.salto = 0
