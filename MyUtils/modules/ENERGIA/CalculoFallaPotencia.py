...
class CalculoFalla:
    ...
    def __init__(self,input_data,falla_buscada, nivel_min,nivel_max, rendimiento, potencia_firme=0) -> None:

        c_handler = log.FileHandler('ENERGÍA-Consigna_Déficit.log',encoding='utf-8')
